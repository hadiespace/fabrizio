document.addEventListener('DOMContentLoaded', () => {
	...
	const pagesList = {
		'Главная': 'index.html',
		'Сумки': 'catalog.html',
		'Клатч Natella': 'product.html',
		'Оформление заказа': 'making-order.html',
		'Заказы': 'orders.html',
		'Заказ': 'order.html',
		'Мои данные': 'my-data.html',
		'Типовая (с изображением)': 'typical-image.html',
		'Типовая (без изображения)': 'typical-no-image.html',
		'Заказ оформлен': 'success.html',
